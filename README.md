...
```txt
Usuário pergunta
  -> LLM 1: query_planner_agent
  -> Backend: tool_executor
  -> LLM 2: query_answer_agent
  -> Resposta final
```
...
```txt
Etapa 1: CHAT_PLANNER_MODEL=gpt-5.4-mini
Etapa 2: CHAT_MODEL=gpt-5.4
Título:  CHAT_TITLE_MODEL=gpt-5.4-nano
```
