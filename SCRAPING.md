...
4. inference_scrape.py com o lattes_full_profiles.json gerado
5. normalize_inferences.py na run de inferencias
6. review_unknown_sex.py quando OPENAI_API_KEY esta configurada
7. promocao do scrape_results/current.json quando a run e valida
8. reconstrucao de profiles_search_corpus e minimal_profiles_context
```
...
profiles_search_corpus_json
profiles_search_corpus_metadata_json
minimal_profiles_context_json
minimal_profiles_context_txt
summary_json
log_path
```
